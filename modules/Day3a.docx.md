...
* Note: these parameters are not used within this exercise but will likeley be included when conducting your own analyses. 
...
```sh
path ![Figure 1.1](/images/Day2.docxfolder/images-018.png)
```
<details>
