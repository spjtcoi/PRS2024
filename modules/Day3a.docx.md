...
|base|AFR-SBP-simulated.sumstats.prscsx|Specifies the GWAS summary statistics file for input|
...
|target|AFR_1kg.hm3.only.csx|Specifies the genotype data file for the target sample|
